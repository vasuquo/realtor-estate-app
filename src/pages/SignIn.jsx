        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'> 
          <form className='space-y-6 mb-6'> 
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p>                
                <Link to="/sign-up" className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out'>Don't have account? Register</Link>
              </p>
              <p>
            ...
            <button type="submit" className='w-full bg-blue-600 text-white px-7 py-3 font-medium text-sm uppercase rounded shadow-sm hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>Sign In</button>
